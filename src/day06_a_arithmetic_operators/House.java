...
public class House {
     ...
     */
        public static void main (String [] args){
            ...
            String result = "The " + houseType + " on " + address + ", " + zipcode + " costs $"
                    + price + ". \nThe " + houseType + " has " + numberOfBedroom + " bedrooms, has "
                    + numberOfBathroom + " bathrooms, and has " + numberOfKitchen + " kitchen. \nIt also includes a basement: "
                    + hasBasement + ", has an attic: " + hasAttic + " and, has a park: " + hasPark + ", is on sale: "
